...
'light_publisher_node = voice_assistant_pkg.light_publisher_node:main',
'servo_angle_publisher=voice_assistant_pkg.servo_angle_publisher:main',
            'servo_publisher=voice_assistant_pkg.servo_publisher:main',
